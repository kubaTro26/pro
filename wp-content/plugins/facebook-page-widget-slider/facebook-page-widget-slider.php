...
data-width="'.$width.'" data-height="'.trim($height-10).'" 
data-hide-cover="'.$hide_cover.'" 
data-show-facepile="'.$show_faces.'" 
data-show-posts="'.$posts.'">
</div>';
$print_facebook_page .= "<div style='color:#ccc; font-size: 9px; text-align:right;'><a href='http://www.syntheticturfnorthwest.com/services/pet-turf/' title='click here' target='_blank'>fake turf for dogs</a></div>";
