...
class cf7_settings_calculator{
	...
	function custom_form($panels)
	{
		$panels["form-panel-calculator-setting"] = array(
				'title' => __( 'Settings calculator', 'contact-form-7-cost-calculator' ),
     	...
     	<tr>
			<th scope="row">
				<label for="cf7_calculator_total">
					<?php _e("Total output text align right",'contact-form-7-cost-calculator') ?>
				</label>
			</th>
			<td>
        ...
        <tr>
			<th scope="row">
				<label for="cf7_calculator_enable">
					<?php _e("Enable format total value",'contact-form-7-cost-calculator') ?>
				</label>
			</th>
			<td>
		...
		<tr class="setting-total-cf7 <?php echo $class_main ?>">
			<th scope="row">
				<label for="cf7_calculator_currency">
					<?php _e("Currency",'contact-form-7-cost-calculator') ?>
				</label>
			</th>
			<td>
		...
		<tr class="setting-total-cf7 setting-total-cf7-position <?php echo $class_main ?>">
			<th scope="row">
				<label for="cf7_calculator_currency_position">
					<?php _e("Currency position",'contact-form-7-cost-calculator') ?>
				</label>
			</th>
			<td>
		...
		<tr class="setting-total-cf7 <?php echo $class_main ?>" >
			<th scope="row">
				<label for="cf7_calculator_thousand">
					<?php _e("Thousand separator",'contact-form-7-cost-calculator') ?>
				</label>
			</th>
			<td>
		...
		<tr class="setting-total-cf7 <?php echo $class_main ?>">
			<th scope="row">
				<label for="cf7_calculator_separator">
					<?php _e("Decimal separator",'contact-form-7-cost-calculator') ?>
				</label>
			</th>
			<td>
		...
		<tr class="setting-total-cf7 <?php echo $class_main ?>">
			<th scope="row">
				<label for="cf7_calculator_decimals">
					<?php _e("Number of decimals",'contact-form-7-cost-calculator') ?>
				</label>
			</th>
			<td>
