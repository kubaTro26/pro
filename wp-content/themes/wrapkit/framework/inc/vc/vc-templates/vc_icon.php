 ...
 */
$type = $icon_fontawesome = $icon_openiconic = $icon_typicons = $icon_entypo = $icon_linecons = $color = $custom_color = $background_style = $background_color = $custom_background_color = $size = $align = $el_class = $el_id = $link = $css_animation = $css = $rel = $custom_size = '';
...
$custom_icon_size = ! empty( $custom_size ) ? $custom_size : '';
$custom_icon_color = 'custom' === $color ? $custom_color : '';

$sd_style = array();
if ( 'custom' === $color ) {
	$sd_style[] = 'color: ' . $custom_icon_color;
}
if ( ! empty( $custom_size ) ) {
	$sd_style[] = 'font-size: ' . $custom_icon_size . '!important';
}
...
<div <?php echo implode( ' ', $wrapper_attributes ); ?>
	...
	if ( $has_style ) {
		...
		<span class="vc_icon_element-icon <?php echo $iconClass; ?>" style="<?php echo implode( ';', $sd_style ); ?>"></span><?php
