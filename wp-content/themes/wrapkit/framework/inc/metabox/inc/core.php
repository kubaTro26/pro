...
class RWMB_Core {
	...
	public function init() {
		load_plugin_textdomain( 'wrapkit', false, plugin_basename( RWMB_DIR ) . '/languages/' );
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="https://docs.metabox.io">' . esc_html__( 'Documentation', 'wrapkit' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . esc_html__( 'Extensions', 'wrapkit' ) . '</a>';
		return $links;
	}
	/**
	 * Register meta boxes.
