...
class RWMB_Media_Field extends RWMB_File_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		self::localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'rwmb_media_add_string', esc_html_x( '+ Add Media', 'media', 'wrapkit' ) ),
			'single'             => apply_filters( 'rwmb_media_single_files_string', esc_html_x( ' file', 'media', 'wrapkit' ) ),
			'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', esc_html_x( ' files', 'media', 'wrapkit' ) ),
			'remove'             => apply_filters( 'rwmb_media_remove_string', esc_html_x( 'Remove', 'media', 'wrapkit' ) ),
			'edit'               => apply_filters( 'rwmb_media_edit_string', esc_html_x( 'Edit', 'media', 'wrapkit' ) ),
			'view'               => apply_filters( 'rwmb_media_view_string', esc_html_x( 'View', 'media', 'wrapkit' ) ),
			'noTitle'            => _x( 'No Title', 'media', 'wrapkit' ),
			'loadingUrl'         => admin_url( 'images/spinner.gif' ),
			'extensions'         => self::get_mime_extensions(),
			'select'             => apply_filters( 'rwmb_media_select_string', esc_html_x( 'Select Files', 'media', 'wrapkit' ) ),
			'or'                 => apply_filters( 'rwmb_media_or_string', esc_html_x( 'or', 'media', 'wrapkit' ) ),
			'uploadInstructions' => apply_filters( 'rwmb_media_upload_instructions_string', esc_html_x( 'Drop files here to upload', 'media', 'wrapkit' ) ),
		) );
	}
