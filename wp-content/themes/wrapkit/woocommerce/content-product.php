...
global $product, $woocommerce_loop, $sd_data;
...
<div <?php post_class( $classes ); ?>>
	<div class="sd-product">
		...
		<div class="sd-product-content clearfix">
			<h3><a href="<?php the_permalink(); ?>"  title="<?php echo esc_attr( sprintf( esc_html__( '%s', 'wrapkit' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h3>
			<?php
			/**
			...
			?>
			<?php echo wc_get_product_category_list( $product->get_id(), ', ', '<span class="sd-prod-cats">', '</span>' ); ?>
